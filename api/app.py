...
from api.middlewares.auth import APIAuthMiddleware
...
def create_app(static_dir: Optional[Path] = None) -> FastAPI:
    ...
    # ============================================================
    # API Authentication (optional, enabled when API_AUTH_TOKEN is set)
    # ============================================================
    
    app.add_middleware(APIAuthMiddleware, auth_token=os.getenv("API_AUTH_TOKEN", ""))
    ...
    async def get_metrics_json():
        """Return application metrics as JSON."""
