...
LOG_FORMAT = '%(asctime)s | %(levelname)-8s | %(name)-20s | %(correlation_id)-8s | %(message)s'
...
def setup_logging(
    ...
    # 安装 correlation ID 过滤器（线程 + 异步安全）
    from src.log_context import install_correlation_filter
